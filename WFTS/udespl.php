...
<head>
	...
	<title>Letters Despatched</title>
...
<h5>Letters Despatched <small>(But Not Sent Physically)</small></h5>



<div class="form-check-inline">
  <label class="form-check-label">Order by
    <input type="radio" class="form-check-input" name="optradio">Despatched Date
  </label>
</div>
<div class="form-check-inline">
...
<div class="form-check-inline">
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="optradio">Despatched To
  </label>
</div>
<br>

<label>Total No.of Letters Despatched = 1</label>
<div class="container">
...
<div class="container">
	...
	<div class="row">
        ...
        <option value="3">Three</option>
     	...
     	<div class="form-check-inline">
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="optradio1">Pls. Examine and Put Up
  </label>
</div>
<div class="form-check-inline">
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="optradio1">Pls. Discuss
  </label>
</div>
     	<div class="form-check-inline">
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="optradio1">Approved
  </label>
</div>
<div class="form-check-inline">
  <label class="form-check-label">
    <input type="radio" class="form-check-input" name="optradio1">No Remarks
  </label>
</div>
