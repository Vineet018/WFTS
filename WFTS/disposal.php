...
<head>
	...
	<title>File Disposal Report</title>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-4">
      <input type="radio" name="1">Summary Report <input type="radio" name="2">Details Report
    </div>
  </div>
</div>
...
<label>Report Date = 04/07/2014</label>
</div>
