...
<head>
	...
	<title>Attach Document with Letter</title>
...
<h5>Attach Document with Letter</h5>
...
<div class="container">
  ...
  <td><a href=""type="" class="" data-toggle="modal" data-target="#myModal">
  Attach
  </a></td>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <label>Letter Id No. : FD/02/2013</label><br>
          <label class="form-label" for="customFile">Select Document : </label>
