...
<head>
	...
	<title>Receive File (Sent thru’ wfts)</title>
...
<div style="padding: 20px">
	<h5>Receive File (Sent thru’ wfts-On Transit)</h5>
</div>
<div class="container">
	<div class="row">
	...
	<div class="row">
			<div class="col-md-5"><label>Total No. of Files Logically Received (On Transit)  -5D</label></div>
	<div class="col-sm-4" style="">
	<label class="radio-inline ">
      <input type="radio" name="optradio" checked>First 50 Records
    </label>
    <label class="radio-inline">
      <input type="radio" name="optradio">All Records
    </label>
</div>
  ...
  <table class="table table-hover">
    ...
    <tbody>
      ...
      Docket date :05/06/2014</td>
      	<td>Bar code</td>
        <td>group Office Group N Finance (Audit)</td>
        <td>Jun 6 2014</td>
        <td><a href="">View</td>
